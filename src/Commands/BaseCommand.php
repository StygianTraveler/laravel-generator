...
class BaseCommand extends Command
{
    ...
    public function getOptions()
    {
        return [
            ...
            ['skip', null, InputOption::VALUE_REQUIRED, 'Skip Specific Items to Generate (migration,model,controllers,api_controller,scaffold_controller,repository,requests,api_requests,scaffold_requests,routes,api_routes,scaffold_routes,localization,permissions,views,tests,menu,dump-autoload)'],
